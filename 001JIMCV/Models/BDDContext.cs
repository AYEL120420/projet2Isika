...
namespace _001JIMCV.Models
{
    public class BDDContext : DbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            Journey ethiopie = new Journey() { DepartureCity = "Aéroport Lyon Saint Exupéry", CountryDestination = "Ethiopie", DepartureDate = "2/12/2024", ReturnDate = "20/12/2024", Persons = 2 };
            Journey france = new Journey() { DepartureCity = "Marseille Provence", CountryDestination = "France", DepartureDate = "10/09/2023", ReturnDate = "24/09/2023", Persons = 4 };
            //Journey japon = new Journey() { CountryDestination = "Japon", DepartureDate = "20 /05/2024", ReturnDate = "03/06/2024", Persons = 6 };
            Journey maroc = new Journey() { DepartureCity = "Bordeaux-Mérignac", CountryDestination = "Maroc", DepartureDate = "20/10/2023", ReturnDate = "02/11/2024", Persons = 2 };
