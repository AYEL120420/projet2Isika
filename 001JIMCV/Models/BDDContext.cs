...
namespace _001JIMCV.Models
{
    public class BDDContext : DbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            Journey inde = new Journey() { CountryDestination = "Inde", ImagePath = "VoyageInde03.jpg", DepartureDate = "10/02/2024", ReturnDate = "24/02/2024", CityDestination="Chennai", Price = 2100, Description = "Aryan, un hôte chaleureux et énergique, vous accueille dans le cadre d'un voyage culinaire à Chennai en Inde. Sa personnalité joviale et sa passion pour la cuisine font de lui le compagnon idéal pour explorer la diversité gastronomique de la ville. Avec lui, vous découvrirez les saveurs épicées et savoureuses de la cuisine locale, en dégustant des plats authentiques tels que le curry Madras renommé. Aryan vous guidera avec enthousiasme à travers les marchés locaux animés, où vous pourrez vous immerger dans la culture culinaire et choisir les meilleurs fruits de mer frais pour vos dégustations. Préparez-vous à vivre une expérience culinaire inoubliable sous la direction bienveillante d'Aryan." };
            Journey inde2 = new Journey() { CountryDestination = "Inde", ImagePath = "IndeVoyage02.jpg", DepartureDate = "20/03/2024", ReturnDate = "30/03/2024", CityDestination = "Varasani", Price = 2500, Description = "Priya, une hôtesse douce et charmante, vous accueille pour un voyage culinaire à Varanasi en Inde. Sa personnalité attentionnée et sa connaissance approfondie de la cuisine locale feront de votre expérience un véritable délice. Priya vous fera découvrir la cuisine authentique de Varanasi, des spécialités locales aux délices sucrés. Vous pourrez déguster de délicieux lassis rafraîchissants et vous laisser emporter par les saveurs exquises de la cuisine traditionnelle. Priya vous guidera également dans une immersion dans la culture spirituelle et culinaire de la ville sainte, en vous faisant découvrir les rituels et les traditions culinaires uniques de Varanasi. Avec Priya comme votre guide attentionné, préparez-vous à vivre une expérience culinaire fascinante et mémorable." };
