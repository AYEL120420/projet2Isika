...
namespace _001JIMCV.Models
{
    public class BDDContext : DbContext
    {
        ...
        public void InitializeDb()
        {
            ...
            User provider8 = new User() { Name = "Raounak", Email = "raounak@gmail.com", Password = LoginDal.EncodeMD5("Isika24provider"), Role = UserEnum.Provider };
            this.Users.AddRange(provider, provider1, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
            ...
            Restauration restauration6 = new Restauration() { Id = 6, Name = "La cuisine de Chennai ", Country = "Inde", City = "Chennai", Type = "Chez l'habitant", Price = 100, Description ="Apprenez à cuisiner et déguster dans la foulée"};
            Restauration restauration7 = new Restauration() { Id = 7, Name = "Les délices de l'Inde", City = "Chennai", Type = "Restaurant typique", Price = 50, Description = "Cusine typique de Chennai" };
